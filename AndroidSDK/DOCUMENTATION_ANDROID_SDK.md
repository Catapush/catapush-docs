...
```groovy
implementation('com.catapush.catapush-android-sdk:core:10.2.18')
```
...
```groovy
implementation('com.catapush.catapush-android-sdk:gms:10.2.18')
```
...
```groovy
implementation('com.catapush.catapush-android-sdk:hms:10.2.18')
```
...
```groovy
implementation('com.catapush.catapush-android-sdk:hms-base:10.2.18')
```
