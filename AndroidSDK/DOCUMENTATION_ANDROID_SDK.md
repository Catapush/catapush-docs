...
```groovy
implementation('com.catapush.catapush-android-sdk:core:12.0.3')
```
...
```groovy
implementation('com.catapush.catapush-android-sdk:gms:12.0.3')
```
...
```groovy
implementation('com.catapush.catapush-android-sdk:hms:12.0.3')
```
...
```groovy
implementation('com.catapush.catapush-android-sdk:hms-base:12.0.3')
```
