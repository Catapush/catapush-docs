...
```groovy
implementation('com.catapush.catapush-android-sdk:core:13.0.3')
```
...
```groovy
implementation('com.catapush.catapush-android-sdk:gms:13.0.3')
```
...
```groovy
implementation('com.catapush.catapush-android-sdk:hms:13.0.3')
```
...
```groovy
implementation('com.catapush.catapush-android-sdk:hms-base:13.0.3')
```
