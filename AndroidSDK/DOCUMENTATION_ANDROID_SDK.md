...
```groovy
implementation('com.catapush.catapush-android-sdk:core:11.0.5')
```
...
```groovy
implementation('com.catapush.catapush-android-sdk:gms:11.0.5')
```
...
```groovy
implementation('com.catapush.catapush-android-sdk:hms:11.0.5')
```
...
```groovy
implementation('com.catapush.catapush-android-sdk:hms-base:11.0.5')
```
